#------------------------------------------------------------------------------------------
# Copyright (c) 2016-2024 Yuta Kawai. All rights reserved.
#-------------------------------------------------------------------------------------------
...
for ((n=StartCycleNum; n<=nCycle; n++)) ; do
    ...
    if [ $n -eq 1 ]; then
        ...
        atmDirPath="${atm_wdir}/cycle0-couple"
        create_dir "${atmDirPath}"

        cp ${atm_init_data_nml} ${atmDirPath}/${atm_init_data_nml##*/}
        cp ${atm_init_data_sfc_nml} ${atmDirPath}/${atm_init_data_sfc_nml##*/}

        cd ${atmDirPath}
        ${MPIRUN} -stdout-proc ./output.%j/%/1000r/stdout -stderr-proc ./output.%j/%/1000r/stderr \
            -n ${atm_PE_NUM} -x OMP_NUM_THREADS=${atm_THREADS_NUM} \
            ${atm_init_data_pe} -N=${atm_init_data_nml##*/}
        ${MPIRUN} -stdout-proc ./output.%j/%/1000r/stdout -stderr-proc ./output.%j/%/1000r/stderr \
            -n ${atm_PE_NUM} -x OMP_NUM_THREADS=${atm_THREADS_NUM} \
            ${atm_init_data_sfc_pe} -N=${atm_init_data_sfc_nml##*/}
    fi
    ...
    sedArgs=`cat <<EOF 
     s!#restart_file_io_nml_InputFile#!atm/cycle$((n-1))-couple/rst.nc!g;
     s!#restart_file_io_nml_OutputFile#!atm/cycle$((n+0))-couple/rst.nc!g;
     ...
     s!#gtool_historyauto_nml_FilePrefix#!atm/cycle$((n+0))-couple/!g;
     s!#rad_DennouAGCM_nml_RstInputFile#!atm/cycle$((n-1))-couple/rst_rad.nc!g;
     s!#rad_DennouAGCM_nml_RstOutputFile#!atm/cycle$((n+0))-couple/rst_rad.nc!g;
...
EOF
    ...
    sedArgs=`cat << EOF
     ...
     s!#ProfUtil_nml_PROF_FNAME#!ocn/cycle$((n+0))-couple/Dennou-OGCM.prof!g;
     s!#gtool_historyauto_nml_IntValue#!${HistIntValueDayCPLRun}.0!g;
     s!#gtool_historyauto_nml_FilePrefix#!ocn/cycle$((n+0))-couple/!g;
     ...
     s!#OcnRestartFile_nml_OutputFileName#!ocn/cycle$((n+0))-couple/RestartOcnData.nc!g;
     s!#OcnRestartFile_nml_IntValue#!730.0!g;
     s!#SIceRestartFile_nml_InputFileName#!${SIceRestartInFile}!g; 
     s!#SIceRestartFile_nml_OutputFileName#!ocn/cycle$((n+0))-couple/RestartSIceData.nc!g;
     ...
     s!#Exp_APECoupleClimate_nml_SfcBCDataDir#!ocn/cycle$((n-1))-couple/!g;
     ...
     s!#Exp_APECoupleClimate_nml_RestartDataDir#!ocn/cycle$((n-1))-standalone/!g;
...
#   ${RUBY} ${CREATE_SURFBCDATA4STANDALONEOGCM_CMD} ${ocnDirPath} ${coupledRunRestartTime} ${coupledRunEndTime} ${ocnDirPath_standalone}/sogcm_SurfBC
    ...
    sedArgs=`cat << EOF
      s!#DOGCM_nml_EXP_NAME#!${EXP_NAME}!g;
      s!#ProfUtil_nml_PROF_FNAME#!ocn/cycle$((n+0))-standalone/Dennou-OGCM.prof!g;
      ...
      s!#gtool_historyauto_nml_FilePrefix#!ocn/cycle$((n+0))-standalone/!g;
      s!#OcnRestartFile_nml_InputFileName#!!g; 
      s!#OcnRestartFile_nml_OutputFileName#!ocn/cycle$((n+0))-standalone/RestartOcnData.nc!g;
      s!#OcnRestartFile_nml_IntValue#!${RestartIntValueDaySTDAloneRun}.0!g;
      s!#SIceRestartFile_nml_InputFileName#!!g; 
      s!#SIceRestartFile_nml_OutputFileName#!ocn/cycle$((n+0))-standalone/RestartSIceData.nc!g;
      ...
      s!#Constants_nml_OcnInitPTemp#!${OcnInitPTemp}d0!g;
      s!#Exp_APECoupleClimate_nml_OcnInitSalt#!${OcnRefSalt}d0!g;
      s!#Exp_APECoupleClimate_nml_SfcBCDataDir#!ocn/cycle$((n))-couple/!g;
      ...
      s!#Exp_APECoupleClimate_nml_RestartDataDir#!ocn/cycle$((n))-couple/!g;
...
EOF
    ...
    #
    ${MPIRUN} -stdout-proc ./output.%j/%/1000r/stdout -stderr-proc ./output.%j/%/1000r/stderr \
        -x OMP_NUM_THREADS=${ocn_standalone_THREADS_NUM} \
        -x PARALLEL=${ocn_standalone_THREADS_NUM} \
        -np ${ocn_standalone_PE_NUM}               \
